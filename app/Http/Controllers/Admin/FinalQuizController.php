...
class FinalQuizController extends BaseVoyagerBaseController
{
        ...
        foreach ($rows as $key => $row) {
            if ($row->field === $request->input('type')) {
                ...
                foreach ($relationshipOptions as $relationshipOption) {
                    if (isset($relationshipOption->quiz_id) && $relationshipOption->quiz_id == $request->id) {
                        $results[] = [
                            'id' => $relationshipOption->{$options->key},
                            'text' => $relationshipOption->{$options->label},
                        ];
                    } elseif (!isset($relationshipOption->quiz_id)) {
                        $results[] = [
                            'id' => $relationshipOption->{$options->key},
                            'text' => $relationshipOption->{$options->label},
                        ];
    ...
    public function create(Request $request)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'course'));
    }
}
