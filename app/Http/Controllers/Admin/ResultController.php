...
class ResultController extends BaseVoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            if(session()->has('result_id')){
                $query->where('user_id', session('result_id'));
            }
        ...
        // dd($dataTypeContent->groupBy('user_id')->selectRaw('user_id, count(*) as total')->with('user'));
        ...
        $result = UserQuizAnswer::groupBy('user_id')->selectRaw('user_id, count(*) as total')->with('user')->get();
    ...
    public function getUser(Request $request) {
        ...
        Session::put('result_id', $request->id);
        ...
        // $result = UserQuizAnswer::groupBy('user_id')->selectRaw('user_id, count(*) as total')->with('user')->get();
        // return view('vendor\voyager\result\select-user', compact('result'));
        // return $result;
        // dd($result->toArray());
    }
