...
class QuizController extends BaseVoyagerBaseController
{
        ...
        foreach ($rows as $key => $row) {
            if ($row->field === $request->input('type')) {
                ...
                foreach ($relationshipOptions as $relationshipOption) {
                    if (isset($relationshipOption->question_id) && $relationshipOption->question_id == $request->id) {
                        $results[] = [
                            'id' => $relationshipOption->{$options->key},
                            'text' => $relationshipOption->{$options->label},
                        ];
                    } elseif (!isset($relationshipOption->question_id)) {
                        $results[] = [
                            'id' => $relationshipOption->{$options->key},
                            'text' => $relationshipOption->{$options->label},
                        ];
