...
@section('content')
    ...
    <main class="px-6 xl:px-64">
        ...
        <section class="quiz_section bg-slate-200 rounded-xl py-8">
            <h1 class="text-2xl font-bold px-8 text-blue-600">Final Quiz.</h1>
            ...
            <form class="mx-auto px-8 no-copy-paste" method="post" action="{{route('final.quiz.post', request()->id)}}" id="quiz_form">
                @csrf
                ...
                @forelse($data->quiz as $ind => $quiz)
                    ...
                    @if($quiz->type === 'bool')
                        ...
                        <div class="mb-4">
                            ...
                            {{-- @dump($quiz->toArray(), $option->toArray()) --}}
