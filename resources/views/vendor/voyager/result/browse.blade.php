...
<div class="container-fluid">
    ...
    <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#selectUser">
        Change User
    </button>
        ...
        <div class="col-md-12">
            <div class="panel panel-bordered">
                <div class="panel-body">
                    ...
                    {{-- @if (count($result) > 0 ) --}}
                    @include('vendor\voyager\result\select-user')
                    {{-- @endif --}}
...
<script>
    $(document).ready(function () {
        ...
        $('.getUser').on('click', function (e) {
            e.preventDefault();
            $('.empty-error').hide();
            var user_id = $('.selecting-user').val();
            if (user_id != '') {
                $.get("{{ route('setUser') }}", {'id' : user_id},
